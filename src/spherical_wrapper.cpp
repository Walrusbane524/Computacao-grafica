...
void SphericalWrapper::transform(Matrix matrix){
...
void SphericalWrapper::translate(){
    Vector vector;
...
void SphericalWrapper::translate(Matrix matrix){
    this->transform(matrix);
}

void SphericalWrapper::rotate(Matrix matrix){
    this->transform(matrix);
}

void SphericalWrapper::scale(Matrix matrix){
    this->transform(matrix);
}